...
and bandwidth test and running the mininet CLI.
...
After all desired test or activities have been completed, the stop()
...
class Mininet( object ):
    ...
    # Probably we should create a test.py for them
